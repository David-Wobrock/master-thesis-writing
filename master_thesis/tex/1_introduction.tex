...
\paragraph{}
The talk by Milanfar \cite{siam_slides_2016}, working at Google Research, about using the graph Laplacian operator for nonconformist image processing purposes awakes curiosity.
...
On the other hand, images are dense matrices, and so will be the resulting linear systems.
