...
We run the algorithm 5 times for each number of processors on the image shown above, from 8 to 192 processors.
...
%\begin{figure}[H]
%  \centering
%  \input{tex/plots/skipping_gs_runtime}
%  \caption{Performances of the inverse subspace iteration part of the algorithm for 500 eigenvalues and skipping every other Gram-Schmidt orthogonalisation.}
%\end{figure}
...
%  \caption{Performances of the Krylov-Schur part of the algorithm for 500 eigenvalues, using SLEPc.}
%\end{figure}
