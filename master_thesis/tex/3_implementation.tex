...
Additionally to varying the number of processors, we also vary the number of computed eigenvalues by the algorithm.
Here are the first 500 eigenvalues of the Laplacian matrix:

\begin{figure}[H]
  \centering
  \input{tex/plots/500_eigenvalues}
  \caption{First 500 eigenvalues of the Laplacian matrix of the considered image.}
\end{figure}
